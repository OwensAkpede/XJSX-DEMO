/***
 * @__core__.XJSXNodeList>append currentNodeParent=e
 * @ (!shouldProcess) removed at NodeList append
 */
           ...
           // if (currentNodeParent){
              if(currentNodeParent&&currentNodeParent.contains(e)) {
               return 
                ...
                currentNodeParent=e
              // if (currentNodeParent instanceof Element) {
              // }else{
              //   currentNodeParent=void 0
               //}
              }
      ...
      ***/
      ...
      if (e.parentNode) {
        ...
        //  e.process.nodes = this.XJSXNodeList(e);
          e.process.nodes ={forEach:function(){}};
  ...
  __core__.createModule([
    {
      ...
      callback: function () {
          ...
          self.global.callback.push(function () {
           self.addChild(__core__.XJSXCompiler(doc.cloneNode(true), self.eval()),true);
          })
      },
    },
    {
         ...
         // }
          ...
          __core__.addEventListener(param, function () {
            if (self.isVisible()) {
              ...
              self.putChild(__core__.XJSXCompiler(doc.cloneNode(true), self.eval));
              // console.log(doc);
            } else {
